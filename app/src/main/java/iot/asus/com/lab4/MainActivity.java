...
import iot.asus.com.lab4.MVVM.VM.NPNHomeViewModel;
import iot.asus.com.lab4.MVVM.View.NPNHomeView;

import com.example.bluesky.lab4.R;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            try {
                ...
                if (isRead){
                    ...
                    value = mRc522.getUidString();
                    Log.d(TAG, value);
                    value = value.replace("-", "");
                    //update to server
                    mHomeViewModel.updateToServer(urlSalinity + value);
                }
